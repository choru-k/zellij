...
pub struct Options {
    ...
    pub pane_synchronized_output_ignore_commands_is_set: ::core::option::Option<bool>,
    #[prost(enumeration="StackDirection", optional, tag="48")]
